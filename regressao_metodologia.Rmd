...
**EXPLICAÇÃO**: O modelo em questão se ajusta bem aos pontos, visto que r-squared é 0.8145886 podemos dizer que o modelo é bem ajustável já que ele descreve 81,4% dos seus dados. E com 95% de confiança podemos afirmar que o coeficiente de inclinação da reta do modelo está entre 4.3 e 5.3.
...
**EXPLICAÇÃO**: Considerando esses fatores podemos afirmar que a variável mestrado pouco interfere no modelo devido ao p-valor maior que 0.05. O modelo em questão explica mais que o modelo 1 já que seu r-squared é maior (0.8450911) e portanto mais próximo de 1.0.
